      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8 relative">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 dark:from-primary dark:via-blue-600 dark:to-purple-600 bg-clip-text text-transparent opacity-0 animate-[fadeInUp_0.8s_ease-out_0.2s_forwards]">
              Self Cinema
            </h1>
            <Sparkles className="absolute -bottom-4 -right-4 h-8 w-8 text-purple-500/60 animate-pulse delay-500" />
          </div>
          
          <p className="text-xl md:text-2xl text-muted-foreground mb-12 opacity-0 animate-[fadeInUp_0.8s_ease-out_0.5s_forwards]">
            私人影院系统 - 享受专属的观影体验
          </p>
          
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <Card className="group hover:shadow-2xl hover:shadow-primary/10 transition-all duration-500 hover:scale-105 opacity-0 animate-[slideInLeft_0.8s_ease-out_0.8s_forwards] border-2 hover:border-primary/50">
            ...
            <Card className="group hover:shadow-2xl hover:shadow-blue-500/10 transition-all duration-500 hover:scale-105 opacity-0 animate-[slideInRight_0.8s_ease-out_0.8s_forwards] border-2 hover:border-blue-500/50">
              <CardHeader className="relative">
          ...
          <div className="backdrop-blur-sm bg-background/50 rounded-lg p-6 border border-border/50 opacity-0 animate-[fadeInScale_0.8s_ease-out_1.1s_forwards]">
